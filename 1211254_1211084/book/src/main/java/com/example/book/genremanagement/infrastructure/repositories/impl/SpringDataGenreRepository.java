package com.example.book.genremanagement.infrastructure.repositories.impl;
...
public interface SpringDataGenreRepository extends GenreRepository, GenreRepoCustom, CrudRepository<Genre, Integer> {
    ...
    @Override
    @Query("SELECT new com.example.book.bookmanagement.services.GenreBookCountDTO(g.genre, COUNT(b))" +
            "FROM Genre g " +
...
class GenreRepoCustomImpl implements GenreRepoCustom {
    ...
    @Override
    public List<GenreLendingsDTO> getAverageLendingsInMonth(LocalDate month, com.example.book.shared.services.Page page){
