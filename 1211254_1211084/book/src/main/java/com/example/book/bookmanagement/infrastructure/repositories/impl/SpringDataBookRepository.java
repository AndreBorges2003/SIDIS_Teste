package com.example.book.bookmanagement.infrastructure.repositories.impl;
...
import com.example.book.bookmanagement.model.Isbn;
...
public interface SpringDataBookRepository  extends BookRepository, BookRepoCustom, CrudRepository<Book, Isbn> {
    ...
    @Override
    @Query("SELECT new com.example.book.bookmanagement.services.BookCountDTO(b, COUNT(l)) " +
                "FROM Book b " +
...
class BookRepoCustomImpl implements BookRepoCustom {
    ...
    @Override
    public List<Book> searchBooks(com.example.book.shared.services.Page page, SearchBooksQuery query)
    {
