...
import com.example.readers.exceptions.ConflictException;
import com.example.readers.exceptions.NotFoundException;
import com.example.readers.readermanagement.model.Genre;
import com.example.readers.readermanagement.repositories.GenreRepository;
import com.example.readers.readermanagement.model.ReaderDetails;
import com.example.readers.readermanagement.repositories.ReaderRepository;
import com.example.readers.shared.repositories.ForbiddenNameRepository;
import com.example.readers.shared.repositories.PhotoRepository;
import com.example.readers.readermanagement.model.Reader;
import com.example.readers.readermanagement.repositories.UserRepository;
...
public class ReaderServiceImpl implements ReaderService {
    ...
    @Override
    public List<ReaderDetails> searchReaders(com.example.readers.shared.services.Page page, SearchReadersQuery query) {
        if (page == null)
            page = new com.example.readers.shared.services.Page(1, 10);
